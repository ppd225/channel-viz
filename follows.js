(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'cvnXYYqEtvnKiPDZAoOwaxduA1hnYVl1kgbtXlbaMGuqvtiP', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1473849226], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Parth\'s Application', // Replaces Xively logo in the header
		...
		dataColor		= '9AC725', // CSS HEX value of color to represent data (omit leading #)
